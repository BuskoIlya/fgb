...
<head>
    ...
    $website_title = $Lang['page_malinovka'];
    require '../blocks/head_pages.php';
    ?>

    <meta property="og:image" content="../../img/og/page_malinovka.jpg"/>
    <meta property="og:description" content="ФГБ: школа го в Минске 'Малиновка'"/>
</head>
<body>
<div id="fgb_body">
    <?php
