...
<head>
    ...
    $website_title = $Lang['page_20-21_1'];
    require '../../blocks/head_news.php';
    ?>
    <script type="text/javascript" src="../../../js/countries.js"></script>
    <script type="text/javascript" src="1027.js"></script>
    <script type="text/javascript" src="../../../js/go_board2.js"></script>

    <meta property="og:image" content="../../../img/og/20201027_belarus-georgia.jpg"/>
</head>
<body>
<div id="fgb_body">
    <?php
    ...
    <div class="inner_page">
        <div class="data_panel">
            <h1>League D 2020/2021 - Round 1</h1>
            <div id="match_id"></div>
        </div>
    </div>
    <?php
...
<script>
    $(document).ready(function () {
        $.get('../../blocks/t_match.php', function (template) {
            $(template).tmpl(m1027).appendTo('#match_id');
        });
    });
</script>