...
<head>
    ...
    $website_title = $Lang['page_19-20_3'];
    require '../../blocks/head_news.php';
    ?>
    <script type="text/javascript" src="../../../js/countries.js"></script>
    <script type="text/javascript" src="1126.js"></script>
    <script type="text/javascript" src="../../../js/go_board2.js"></script>

    <meta property="og:image" content="../../../img/og/20191126_bulgaria-belarus.jpg"/>
</head>
<body>
<div id="fgb_body">
    <?php
    ...
    <div class="inner_page">
        <div class="data_panel">
            <h1>League D 2019/2020 - Round 3</h1>
            <div id="match_id"></div>
        </div>
    </div>
    <?php
...
<script>
    $(document).ready(function () {
        $.get('../../blocks/t_match.html', function (template) {
            $(template).tmpl(m1126).appendTo('#match_id');
        });
    });
</script>