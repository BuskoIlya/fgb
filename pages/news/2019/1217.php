...
<head>
    ...
    $website_title = $Lang['page_19-20_4'];
    ...
    <meta property="og:image" content="../../../img/og/20191217_spain-belarus.jpg"/>
</head>
<body>
<div id="fgb_body">
    <?php
    ...
    <div class="inner_page">
        <div class="data_panel">
            <h1>League D 2019/2020 - Round 4</h1>
            <div id="match_id"></div>
        </div>
    </div>
    <?php
...
<script>
    $(document).ready(function () {
        $.get('../../blocks/t_match.php', function (template) {
            $(template).tmpl(m1217).appendTo('#match_id');
        });
    });
</script>